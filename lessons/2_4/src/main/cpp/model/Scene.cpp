...
void initModels(std::map<std::string, std::shared_ptr<Graphic::Model>> &models){
    ...
    Graphic::registerShader(simpleShader,
                            "..\\lessons\\2_4\\src\\main\\glsl\\model\\cube\\shader.vs.glsl",
                            "..\\lessons\\2_4\\src\\main\\glsl\\model\\cube\\shader.frag.glsl"
    );

    GLuint lightShader = glCreateProgram();
    Graphic::registerShader(lightShader,
                            "..\\lessons\\2_4\\src\\main\\glsl\\model\\light\\shader.vs.glsl",
                            "..\\lessons\\2_4\\src\\main\\glsl\\model\\light\\shader.frag.glsl"
    );

    GLuint simpleCubeTexture = Graphic::loadTexture("..\\assets\\cube.jpg");
    GLuint containerTexture = Graphic::loadTexture("..\\assets\\container.png");
    ...
    models["container"] = make_shared<Graphic::Cube>(Graphic::Cube(simpleShader, containerTexture, 1));
